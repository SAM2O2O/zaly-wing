...
import com.akaxin.zaly.wing.client.ZalySSLClient;
 ...
 */
public class ZalysClient2Handler extends SimpleChannelInboundHandler<RedisCommand> {
	private static final Logger logger = LoggerFactory.getLogger(ZalysClient2Handler.class);

	private final ZalySSLClient zalysClient;

	public ZalysClient2Handler(ZalySSLClient zalysClient) {
